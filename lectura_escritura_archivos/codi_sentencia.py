...
Hay que verificar que python apunta hacia el espacio correcto donde se encuentra el archivo con el que pretendemos trabajar.'''
#La primera opcion que no permite hacer esto es mediante la "ruta relativa del archivo":
